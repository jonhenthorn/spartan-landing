...
- `docs/SQUARE-SANDBOX-PROVIDER-FIXTURES.md` — the mocked-only provider-fixture boundary for five remaining sandbox cases. Live execution is deliberately blocked in code until a dedicated temporary Square Sandbox OAuth client and full authorization-revocation procedure are separately implemented, reviewed, and approved.
