...
CREATE TABLE alert_delivery_v5_migration_guard (
  invalid_evidence_count INTEGER NOT NULL CHECK (invalid_evidence_count = 0)
);

INSERT INTO alert_delivery_v5_migration_guard (invalid_evidence_count)
SELECT COUNT(*)
...
CREATE TABLE alert_deliveries_v5 (
...
INSERT INTO alert_deliveries_v5 (
...
SELECT ABS(
  ...
  (SELECT COUNT(*) FROM alert_deliveries_v5)
);

DROP TABLE alert_delivery_v5_migration_guard;

DROP TABLE alert_deliveries;
ALTER TABLE alert_deliveries_v5 RENAME TO alert_deliveries;
