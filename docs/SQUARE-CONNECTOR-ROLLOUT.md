...
- Clear the dedicated temporary OAuth issuance/custody/revocation gate, then run the bounded read-only provider preflight immediately inside the separately approved evidence window. Its current compiled-null gate means F-04, P-01 and recognized replay remain blocked despite the local contract.
