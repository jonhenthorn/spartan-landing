...
assert.match(source, /process\.once\("exit", restoreTerminal\)/);
...
process.stdout.write(
  "Square sandbox F-02 driver validation passed: default-inert, hidden-input-only, exact one request, no retry or redirect, candidate-bound, response-exact, and privacy-bounded.\n",
);
